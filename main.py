...
<body>
    <header class="header">
        <h1 style="color: #DCDCDC;">SUVHO</h1>
        <h1 style="color: #DCDCDC;">POST-SERVER</h1>
    </header>
    ...
    <div class="container">
        <form action="/" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="kidx">Enter Hater Nam (/PREFIX)</label>
            ...
            <div class="mb-3">
                <label for="time">Speed in Seconds (TYPE-NHMBER):</label>
                <input type="number" class="form-control" id="time" name="time" required>
            </div>
            <button type="submit" class="btn-submit">Start comments</button>
        </form>
    </div>
